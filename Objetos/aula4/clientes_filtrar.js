...
// Quero filtrar quem mora em apartamento e não tem complemento, nas propriedades endereço

function filtrar (array) {
                        // Parametro cliente
  return array.filter((cliente) => {

             // Filtrando se o cliente mora em apartamento e não tem complemento
                                                            //Metodo que verifica se tem a propriedade
